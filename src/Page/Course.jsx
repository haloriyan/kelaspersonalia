            ...
            <>
                ...
                <div className="content">
                    ...
                    <div className={`inner_content ${styles.InnerContent}`}>
                        <h3 className={styles.JumboTitle} style={{marginTop: 20}}>Deskripsi Pelatihan</h3>
                        ...
                        <div className={styles.MateriArea}>
                            {
                                course.materials.map((materi, m) => (
                                    <div key={m} className={styles.MateriItem}>
                                        <img src={`${config.baseUrl}/storage/thumbs/${materi.thumbnail}`} className={styles.MateriImage} />
